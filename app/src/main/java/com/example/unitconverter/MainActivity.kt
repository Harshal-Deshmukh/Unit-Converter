...
fun unitConverter(){
    ...
    val titleStyle = TextStyle(
        ...
        color = Color(0xFF1E88E5), // nice blue (professional look)
    ...
    {
    //Here all UI elements one upon another
        //Heading
    Text(text = "Unit Converter: ", style = titleStyle)
        Spacer(modifier = Modifier.height(16.dp))
    OutlinedTextField(
        //Here all changes are seen
        value = inputValue,
        onValueChange ={
        inputValue= it
            convertUnits()
    ...
    Row {
        //Here all UI elements side by side
        //Input Box
        Box{
            //Input Button
       ...
       Spacer(modifier = Modifier.height(16.dp))
        Text(text = outputValue, style = resultStyle)
    }
}
